...
window.DEMOS = [
  ...
  { slug:'alta',         industry:'时尚', title:'场合穿搭',         tagline:'连淘宝导入买过的衣服 + 上传想搭的 → AI 出整套 + 缺的直接给购买链接', emoji:'👗', accent:'#9b5cc2', status:'live' },
  ...
  { slug:'dinner',       industry:'餐饮', title:'今天吃什么',       tagline:'冰箱有啥 · 先吃快坏的 · 排一周，都从这问起', emoji:'🍲', accent:'#e0651f', status:'live' },
